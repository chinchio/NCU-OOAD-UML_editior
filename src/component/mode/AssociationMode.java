...
public class AssociationMode extends Mode {
    ...
    public AssociationMode(Canvas canvas, CanvasBasicDrawTools frontLayerBasicDrawTools, CanvasBasicDrawTools baseLayeDrawTools) {
    ...
    public void mouseReleased(MouseEvent e) {
        if (connectionStartPoint != null) { //null point exception !!!
            ...
            if (connectionEndPoint != null) { //null point exception !!!
                BasicLine line = new AssociationLine(connectionStartPoint.getX(), connectionStartPoint.getY(), connectionEndPoint.getX(), connectionEndPoint.getY());
